using BlogSite_MVC.Areas.Admin.Models;
using Microsoft.AspNetCore.Mvc;
using Microsoft.AspNetCore.Mvc.Rendering;

namespace BlogSite_MVC.Areas.Admin.Controllers
{
    [Area("Admin")]
    public class GonderilerController : Controller
    {
        ...
        {
            ViewBag.Mesaj = durum == "eklendi" ? "Gönderi başarıyla oluşturuldu" : durum == "duzenlendi" ? "Gönderi Başarıyla güncellendi" : durum == "silindi" ? "Gönderi başarıyla silindi" : null;
